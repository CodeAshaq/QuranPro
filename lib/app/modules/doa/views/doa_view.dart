                  ...
                  return Card(
                    ...
                    child: Theme(
                      data: ThemeData(
                        ...
                        unselectedWidgetColor: Get.isDarkMode ? tertiary : secondary, 
                        colorScheme: ColorScheme.fromSwatch().copyWith(primary: Get.isDarkMode ? tertiary : secondary),
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.only(
                                              left: 8, right: 8),
                                          child: Text(
                                              items[index].latinArab.toString(),
                                              style: GoogleFonts.poppins(
                                                  color: Get.isDarkMode
                                                      ? primaryDark
                                                      : secondary,
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                              items[index].translate.toString(),
                                              style: GoogleFonts.poppins(
                                                  color: Get.isDarkMode
                                                      ? primaryDark
                                                      : secondary,
